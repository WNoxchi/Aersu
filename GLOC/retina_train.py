...
# Wayne Nixalo 2017-Dec-26 22:34

# USAGE: https://github.com/fizyr/keras-retinanet
...
# This is modified from the original (orig Copyright below):
...
def create_models(num_classes, weights='imagenet'):
